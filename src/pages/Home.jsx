...
function FeatureCard({fas, title, para}){
    return(
        ...
        <div className="Feature_card" class="bg-[rgba(13,17,23,0.3)] backdrop-blur-md border border-[rgba(255,255,255,0.1)] rounded-[12px] p-6 transition-transform duration-300 ease-in-out">
            ...
            <h3 class="special-font  text-[#ffffff] mb-4 text-2xl font-bold">{title}</h3>
...
function TechStats({sn, sl}){
    return(
        ...
        <div className="stat-item" class=" flex flex-col text-center p-4 bg-[rgba(255,255,255,0.05)] rounded-lg backdrop-blur-[10px] border border-[rgba(255,215,0,0.1)] transition-all duration-300 ease-in-out"> 
            <span className="stat-number " class=" special-font block text-2xl font-bold text-[#00f2ff] px-0 [text-shadow:0_0_15px_rgba(0,242,255,0.3)]">{sn}</span>
            <span className="stat-label" class="special-font  text-[#ffffff] my-2">{sl}</span>
        </div>
        </>
    )
}
    ...
    return(
        ...
        <div class="relative  flex items-center justify-center  p-30 pt-0 mb-10 pb-0  z-20 m-10 mt-40">
            <div class="text-center relative m-0 z-2">
                <h1 class="special-font text-6xl mb-4 font-bold font-orbitron">Welcome to <span class="text-[#8fff00]">The Zigbee Club</span></h1>
                <h3 class="special-font text-3xl mb-8 font-semibold">The <span class="text-[#8fff00]">CSE-IoT</span> Club</h3>
                <p class="special-font text-xl my-10">Lets connect and Create...</p>
                <div class="special-font flex gap-8 mt-8 justify-center">            
...
<HotCardsSlider/>
        ...
        <div className="Feature_section" class="flex flex-col items-center justify-center min-h-[calc(100vh-60px)] px-30 py- z-20 mx-10 my-0">
            <h2 className="section-title " class="text-4xl special-font mb-16 font-bold"><span class="text-[#8fff00]">Explore</span> The Hive</h2>
